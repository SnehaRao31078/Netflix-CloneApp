          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setFile(selected);
                setImagePreview(URL.createObjectURL(selected)); // instant preview
              }}
            />
            ...
            <input
              ...
              onChange={(e) => {
                const selected = e.target.files[0];
                setVideo(selected);
                setVideoPreview(URL.createObjectURL(selected)); // instant preview
              }}
            />
